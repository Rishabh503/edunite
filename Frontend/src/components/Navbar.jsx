  ...
  return (
    <nav className="fixed top-0 w-full bg-gradient-to-r from-gray-800 to-gray-900 text-white z-50 shadow-lg">
      <div className="container mx-auto flex items-center justify-between px-4 py-3 md:py-4">
        ...
        >
          <ul
            className={`md:flex md:items-center md:space-x-6 space-y-3 md:space-y-0 text-base font-medium ${
          ...
          >
            ...
            <li>
              <a
                href={`https://workhack.vercel.app/?email=${encodeURIComponent(
                  localStorage.getItem("eduassist_user_email") || ""
                )}`}
                target="_blank"
            ...
            {!userEmail && (
              <>
                <li>
                  <Link
                    to="/register"
                    className="block px-4 py-2 bg-blue-500/80 text-white font-semibold rounded hover:bg-blue-600 transition text-center mt-2 md:mt-0"
                  >
                    Register
                  </Link>
                </li>
                <li>
                  <Link
                    to="/login"
                    className="block px-4 py-2 bg-blue-500/80 text-white font-semibold rounded hover:bg-yellow-400 transition text-center mt-2 md:mt-0"
                  >
                    Login
                  </Link>
                </li>
